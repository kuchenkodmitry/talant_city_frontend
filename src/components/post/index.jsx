                                ...
                                {isLoaded ? [data].map((e, i) => {
                                    return (
                                        courseId !== "superMemory" ?
                                            ...
                                            <div>
                                            <ReactPlayer className={style.mobileFlex} width='340px' height='200px' url={"https://www.youtube.com/watch?v=JDmajwNQt4E"} key={i} />
                                            <ReactPlayer className={style.videoSize} url={"https://www.youtube.com/watch?v=JDmajwNQt4E"} key={i} />
                                        </div>
                                    )
                                }) : ''}
                            </div>
